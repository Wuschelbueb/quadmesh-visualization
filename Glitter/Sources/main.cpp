...
int main(int argc, char *argv[])
{
    ...
    unsigned char *data = stbi_load("../../Glitter/Objects/square.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("../../Glitter/Objects/luigi.png", &width, &height, &nrChannels, 0);
    if (data)
    {
...
//     // how many elements of quad texture have to be seen
    ourShader.setInt("elements_u", 2.f);
    ourShader.setInt("elements_v", 2.f);
