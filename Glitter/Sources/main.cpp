...
int main(int argc, char *argv[])
{
    ...
    unsigned char *data = stbi_load("../../Glitter/Resources/square.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("../../Glitter/Resources/luigi.png", &width, &height, &nrChannels, 0);
    if (data)
    {
